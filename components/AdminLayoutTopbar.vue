    ...
    <div class="drawer-side">
      ...
      <ul class="menu menu-lg p-4 w-80 min-h-full bg-base-200 text-base-content flex flex-col justify-between">
        <div>
          ...
          <li>
            <RouterLink to="/admin" :class="checkActiveMenu('admin')"><svg xmlns="http://www.w3.org/2000/svg"
          ...
          <li v-if="pb.authStore.model.manageCategories">
            <RouterLink :class="checkActiveMenu('admin-categories')" to="/admin/categories"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
          ...
          <li v-if="pb.authStore.model.manageLocations">
            <RouterLink :class="checkActiveMenu('admin-locations')" to="/admin/locations"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
          ...
          <li v-if="pb.authStore.model.managePosts">
            <RouterLink :class="checkActiveMenu('admin-posts')" to="/admin/posts"><svg
              ...
              Nachrichten</RouterLink>
          </li>
          <li v-if="pb.authStore.model.manageWelcome">
            <RouterLink :class="checkActiveMenu('admin-welcomemsg')" to="/admin/welcomemsg"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
          ...
          <li v-if="pb.authStore.model.manageUsers">
            <RouterLink :class="checkActiveMenu('admin-users')" to="/admin/users">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
          ...
          <li v-if="pb.authStore.model.superadmin">
            <a :href="$config.public.pocketbaseUrl + '/_'"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
          ...
          <li @click="logout()">
            <a><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
        ...
        <div>
          <div class="flex flex-row space-x-1 justify-center ">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
              class="w-4 h-4 mt-[2px] fill-red-600">
              <path
            ...
            <span>by Jens Krieger-Juhnke</span>
          </div>
        </div>
