<template>
  <AdminLayoutHeader title="Kategorien verwalten" subtitle="Hier kannst du alle Kategorien bearbeiten." :path="[
    ...
    <dialog id="my_modal_1" class="modal">
      <div class="modal-box w-11/12 max-w-7xl">
        ...
        <div class="py-4">
          ...
          <input type="text" v-model="description" placeholder="kreatives, nachdenkliches, musikalisches, sportliches"
  ...
  <div class="pl-3">
    <div class="overflow-x-auto">
      <AdminHighPermissionWarning reason="Du bist berechtigt, alle Kategorien zu bearbeiten. Dabei kannst du bestehende
