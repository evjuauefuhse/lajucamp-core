<template>
  <AdminLayoutHeader title="Seitenverwaltung"
    subtitle='Hier kannst du die Seiten verwalten, die in der App unter "Mehr" angezeigt werden.' :path="[
      ...
      <div class="py-4">
        <div class="flex flex-col space-y-3">
          <div>
            ...
            <input type="text" v-model="name" placeholder="Beispieltitel" class="input input-bordered w-full"
              :disabled="submitting" />
          </div>
          <div>
            <div class="label">
            ...
            <div class="flex flex-row">
              <div class="w-full">
                <input type="range" min="0" max="100" class="range range-secondary" step="1" v-model="order" />
              ...
              <div>
                <input type="number" class="input w-24 ml-3 input-bordered" v-model="order" />
              </div>
            </div>
          </div>
          <div>
            <div class="label w-full">
              <div class="w-full flex flex-row justify-between">
                ...
                <a target="_blank" href="https://heroicons.com/" class="btn btn-xs">Zur Icon-Bibliothek</a>
              </div>
            </div>
            <textarea class="textarea textarea-bordered w-full" placeholder="<svg ... />" v-model="icon"></textarea>
          </div>
          <div>
            <div class="label">
          ...
          <label class="label cursor-pointer">
            ...
            <input type="checkbox" class="toggle" v-model="islink" :disabled="submitting" />
          </label>
          <div v-if="!islink">
            <div class="w-full z-8 min-w-50%">
              ...
              <ClientOnly fallback-tag="div" fallback="Bitte warten, der Editor lädt...">
                <ckeditor class="z-8 h-full pt-3" :editor="$ckeditor.customEditor" v-model="content"
                  :config="editorconfig" />
              </ClientOnly>
            </div>
          </div>
