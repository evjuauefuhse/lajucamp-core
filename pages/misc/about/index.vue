  ...
  <div class="flex flex-col space-y-3">
    <div @click="clickLogo" class="card card-compact w-full bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <span class="text-center">Copyright © 2026 Evangelische Jugend an Aue und Fuhse.</span>
      </div>
    </div>
    <div class="card card-compact w-full bg-base-100 shadow-xl">
      <div class="card-body">
        <h2 class="card-title">Mitwirkende</h2>
        <div class="flex flex-col space-y-1">
          <div class="flex justify-center mb-3">
            <div class="avatar placeholder">
              <div class="bg-success text-base-100 rounded-full w-16">
                <span class="text-2xl">JK</span>
              </div>
            </div>
          </div>
          <span class="text-center font-bold text-lg">Jens Krieger-Juhnke</span>
          <span class="text-center text-sm font-light">Hauptentwickler</span>
    ...
    <RouterLink to="/misc/about/changelog">
      <div class="card card-compact w-full bg-base-100 shadow-xl">
        <div class="card-body">
          <h2 class="card-title">Changelog<span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
    ...
    <RouterLink to="/misc/about/license">
      <div class="card card-compact w-full bg-base-100 shadow-xl">
        <div class="card-body">
          <h2 class="card-title">Lizenzvereinbarung<span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
